...
class Migrate_Create_products_has_logistics_global_20200606220010 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $ddl->addConstraint(new Constraint\ForeignKey($fkprefix . '_logistics_global', 'logistics_global_id', self::$prefixTable . 'logistics_global', 'id'));
    }
