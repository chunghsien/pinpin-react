...
class Migrate_Create_products_spec_volume_20200916153216 extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $ddl->addColumn(MySQLColumnFactory::buildColumn('products_spec_id', 'int', [
            'unsigned' => true
        ]));
        ...
        $ddl->addConstraint(new Constraint\ForeignKey('fk1_' . $this->tailTable, 'products_spec_id', self::$prefixTable . 'products_spec', 'id'
            ));
    }
