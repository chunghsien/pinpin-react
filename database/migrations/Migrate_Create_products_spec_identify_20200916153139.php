...
//產品識別
class Migrate_Create_products_spec_identify_20200916153139 extends AbstractMigration
{
    /**
     ...
     * @var string
     */
    protected $table = 'products_spec_identify';
    ...
    public function up()
    {
        ...
        $ddl->addConstraint(new Constraint\ForeignKey(
            'fk1_'.$this->tailTable,
            'products_spec_id',
            self::$prefixTable.'products_spec',
            'id'
        ));
