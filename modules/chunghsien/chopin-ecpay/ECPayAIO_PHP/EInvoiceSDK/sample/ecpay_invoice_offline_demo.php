...
try {
    ...
    $aItems	= [];
    // 商品資訊
    array_push($ecpay_invoice->Send['Items'], ['ItemName' => '商品名稱一', 'ItemCount' => 1, 'ItemWord' => '批', 'ItemPrice' => 100, 'ItemTaxType' => 1, 'ItemAmount' => 100, 'ItemRemark' => '商品備註一'  ]) ;
    array_push($ecpay_invoice->Send['Items'], ['ItemName' => '商品名稱二', 'ItemCount' => 1, 'ItemWord' => '批', 'ItemPrice' => 150, 'ItemTaxType' => 1, 'ItemAmount' => 150, 'ItemRemark' => '商品備註二' ]) ;
