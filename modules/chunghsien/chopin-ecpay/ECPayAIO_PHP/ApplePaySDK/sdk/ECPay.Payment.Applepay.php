...
class ECPay_ApplePay_Send extends ECPay_ApplePay_IO
{
    ...
    * 背景送出資料
    */
    public static function CheckOut($arParameters = [], $HashKey='', $HashIV='', $Payment_Method = '', $ServiceURL='')
    {
...
abstract class ECPay_ApplePay_Verification
{
    ...
    * 檢查各別參數
    */
    abstract public function check_extend_string($arParameters = []);

    /**
    * 檢查各別參數
    */
    abstract public function check_exception($arParameters = []);
    ...
    * 處理需要轉換為urlencode的參數
    */
    public function urlencode_process($arParameters = [])
    {
    ...
    * 產生壓碼
    */
    public function generate_checkmacvalue($arParameters = [], $HashKey = '', $HashIV = '')
    {
        $sCheck_MacValue = '';
    ...
    public function generate_encrypt_data($sPaymentToken, $HashKey, $HashIV)
    {
    ...
    * 處理urldecode的參數
    */
    public function urldecode_process($arParameters = [])
    {
        foreach ($arParameters as $key => $value) {
            if (isset($this->urlencode_field[$key])) {
...
class ECPay_ApplePay_CheckMacValue
{
    ...
    * @param        string  $sIv            IV
    */
    public static function encrypt_data($sPost_Data = '', $sKey = '', $sIv = '')
    {
    ...
    * @param        string  $sIv            IV
    */
    public static function decrypt_data($sPost_Data = '', $sKey = '', $sIv = '')
    {
        // 取代為與 dotNet 相符的字元
