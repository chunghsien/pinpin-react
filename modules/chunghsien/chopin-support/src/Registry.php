...
class Registry extends \ArrayObject
{
     ...
     * @var string
     */
    private static $_registryClassName = 'Chopin\Support\Registry';
     ...
     *
     * @param Registry $registry An object instance of type Laminas_Registry,
     *   or a subclass.
     * @return void
     ...
     */
    public static function setClassName($registryClassName = 'Chopin\Support\Registry')
    {
        if (self::$_registry !== null) {
            throw new \Exception('Registry is already initialized');
        }
