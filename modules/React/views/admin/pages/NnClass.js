...
const NnClass = () => {
    ...
    return (
        <ClassPart table="nn_class" tableHeaderLabel="clsss_level3_datagrid" classRelation={classRelation} href="/admin/nn_class" paginateUrl={'/'+SYS_LANG+'/api/admin/nn_class'} {...{classColumns, paginationOptions, clickClearFilter}}  />
    );
};
