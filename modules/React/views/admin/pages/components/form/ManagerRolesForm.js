...
const ManagerRolesForm = (props) => {
  ...
  const manager_roles = formRows ? formRows.manager_roles : undefined
  useEffect(() => {
      ...
      <CTabPane data-tab="default-form">
        <CCard className="tab-card">
          <Form
            ...
            {...props}
          >
            <input type="hidden" name="id" ref={register()} defaultValue={manager_roles && manager_roles.id} />
            <input type="hidden" name="module_id" ref={register()} defaultValue={2} />
            <input type="hidden" name="parent_id" ref={register()} defaultValue={manager_roles && manager_roles.parent_id} />
            <input type="hidden" name="depth" ref={register()} defaultValue={manager_roles && manager_roles.depth} />
            <CRow className="mt-2">
              <CCol>
                <CFormGroup>
                  ...
                  <CInputGroup className={errors.name && 'is-invalid'}>
                    <CInput
                      ...
                      defaultValue={manager_roles && manager_roles.name}
                    />
                    <CInputGroupAppend>
...
export default connect(mapStateToProps)(ManagerRolesForm);
