                                ...
                                <CCol md="4" sm="12" className="mt-2">
                                    <CFormGroup>
                                        ...
                                        <CInputGroup className={errors.name && 'is-invalid'}>
                                            ...
                                            />
                                            <CInputGroupAppend>
                                                <CInputGroupText className="bg-light text-muted">{remaining.name ? remaining.title : 0}/{maxLength.name}</CInputGroupText>
                                            </CInputGroupAppend>
                                        </CInputGroup>
                                ...
                                <CCol md="4" sm="12" className="mt-2">
                                    <CFormGroup>
                                        ...
                                        <CInputGroup className={errors.route && 'is-invalid'}>
                                            ...
                                            />
                                            <CInputGroupAppend>
                                                <CInputGroupText className="bg-light text-muted">{remaining.route ? remaining.title : 0}/{maxLength.route}</CInputGroupText>
                                            </CInputGroupAppend>
                                        </CInputGroup>
