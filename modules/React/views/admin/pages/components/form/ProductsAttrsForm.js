                ...
                <CTabPane data-tab="default-form">
                    <CCard className="tab-card">
                        <Form innerRef={formRef} href={href} griduse {...methods} remainderChange={remainderChange}>
                            ...
                            <input type="hidden" name="table" defaultValue="products" ref={register()} />
                            <input type="hidden" name="table_id" defaultValue="0" ref={register()} />
                            <CRow className="mt-2">
                                <CCol md="4" sm="12">
                                    <CFormGroup>
...
export default ProductsAttrsForm;