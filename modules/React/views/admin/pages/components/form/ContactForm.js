                            ...
                            <CRow>
                                <CCol>
                                    ...
                                    <CSelect
                                        ...
                                        defaultValue={formRow.contact.language_has_locale}
                                        custom
                                    >
                                        {
                                ...
                                <CCol>
                                    ...
                                    <h5 className="font-weight-bold">{formRow.contact.full_name}</h5>
                                </CCol>
                            </CRow>
                            <CRow className="mt-2">
                                <CCol>
                                    <CLabel>{t('columns-email')}</CLabel>
                                    <h5 className="font-weight-bold">{formRow.contact.email}</h5>
                                </CCol>
                            </CRow>
                            <CRow className="mt-2">
                                <CCol>
                                    <CLabel>{t('columns-subject')}</CLabel>
                                    <h5 className="font-weight-bold">{formRow.contact.subject}</h5>
                                </CCol>
                            </CRow>
                            <CRow className="mt-2">
                                <CCol>
                                    <CLabel>{t('columns-commet')}</CLabel>
                                    <pre className="font-weight-bold h5">{formRow.contact.commet}</pre>
                                </CCol>
                            </CRow>
                                ...
                                <CCol md="12" sm="12">
                                    <div className="textarea-group">
                                        ...
                                        */}
                                        ...
                                        <div className="textarea-group">
                                            <CTextarea readOnly={formRow.contact.is_reply == 1} disabled={formRow.contact.is_reply == 1} defaultValue={formRow.reply} className="noresize" invalid={errors.reply ? true : false} name="reply" maxLength="1024" onChange={remainderChange} rows="5" innerRef={register({ required: true })} />
                            ...
                            <CCol>
                                <CFormGroup>
                                    ...
                                    <div className="d-blobk">
                                        <CSwitch defaultValue={formRow.is_reply} defaultChecked name="is_reply" color="primary" innerRef={register()} />
                                    </div>
                                </CFormGroup>
                            </CCol>
