        ...
        <CTabContent>
            <CTabPane data-tab="facebook_tag-form">
                <CCard className="tab-card">
                    <Form innerRef={formRef} href={href} griduse {...methods} {...props} remainderChange={remainderChange} setMediaState={setMediaState} setFileRequire={setFileRequire}>
                        ...
                        <CRow>
                            <CCol md="6" sm="12" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <CInputGroup>
                                        <CInput name="fb_colon_app_id" maxLength="64" innerRef={register()} readOnly />
                                        <CInputGroupAppend>
                            ...
                            <CCol md="6" sm="12" className="mt-2">
                                <CFormGroup className={errors.keyword && 'is-invalid'}>
                                    ...
                                    <CInputGroup className={errors.og_colon_title && 'is-invalid'}>
                                        <CInput name="og_colon_title" invalid={errors.og_colon_title ? true : false} maxLength="64" onChange={remainderChange} innerRef={register({ required: true })} />
                                        <CInputGroupAppend>
                            ...
                            <CCol md="12" sm="12" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <CInputGroup className={errors.og_colon_url && 'is-invalid'}>
                                        <CInput name="og_colon_url" invalid={errors.og_colon_url ? true : false} maxLength="192" onChange={remainderChange} innerRef={register({ required: true })} />
                                        <CInputGroupAppend>
                            ...
                            <CCol md="12" sm="12" className="mt-2">
                                <div className="textarea-group">
                                    ...
                                    <div className="textarea-group">
                                        <CTextarea className="noresize" invalid={errors.og_colon_description ? true : false} name="og_colon_description" maxLength="255" onChange={remainderChange} rows="5" innerRef={register({ required: true })} />
                            ...
                            */}
                            <CCol md="6" sm="12" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <CInputGroup>
                                        <CInput name="og_colon_locale" maxLength="96" readOnly onChange={remainderChange} innerRef={register()} />
                                        <CInputGroupAppend>
                            ...
                            <CCol md="6" sm="12" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <img className={'mt-2 img-fluid form-thumbnail ' + (mediaState.og_colon_image ? '' : 'd-none')} src={mediaState.og_colon_image && mediaState.og_colon_image.path} />
                            ...
                            <CCol md="6" sm="12" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <CInputGroup>
                                        <CInput name="og_colon_image_colon_secure_url" readOnly maxLength="255" onChange={remainderChange} innerRef={register()} />
                                        <CInputGroupAppend>
                            ...
                            <CCol md="4" sm="12" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <CInputGroup>
                                        <CInput name="og_colon_image_colon_type" maxLength="48" readOnly onChange={remainderChange} innerRef={register()} />
                                        <CInputGroupAppend>
                            ...
                            <CCol md="4" sm="6" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <CInputGroup>
                                        <CInput name="og_colon_image_colon_width" maxLength="32" readOnly onChange={remainderChange} innerRef={register()} />
                                        <CInputGroupAppend>
                            ...
                            <CCol md="4" sm="6" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <CInputGroup>
                                        <CInput name="og_colon_image_colon_height" maxLength="32" readOnly onChange={remainderChange} innerRef={register()} />
                                        <CInputGroupAppend>
                            ...
                            <CCol md="6" sm="12" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <img className={'mt-2 img-fluid ' + (mediaState.og_colon_video ? '' : 'd-none')} src={mediaState.og_colon_video && mediaState.og_colon_video.path} />
                                </CFormGroup>
                            </CCol>
                            <CCol md="6" sm="12" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <CInputGroup>
                                        <CInput name="og_colon_video_colon_secure_url" readOnly type="text" maxLength="255" onChange={remainderChange} innerRef={register()} />
                                        <CInputGroupAppend>
                            ...
                            <CCol md="4" sm="12" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <CInputGroup>
                                        <CInput name="og_colon_video_colon_type" maxLength="48" onChange={remainderChange} innerRef={register()} />
                                        <CInputGroupAppend>
                            ...
                            <CCol md="4" sm="6" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <CInputGroup>
                                        <CInput name="og_colon_video_colon_width" maxLength="32" onChange={remainderChange} innerRef={register()} />
                                        <CInputGroupAppend>
                            ...
                            <CCol md="4" sm="6" className="mt-2">
                                <CFormGroup>
                                    ...
                                    <CInputGroup>
                                        <CInput name="og_colon_video_colon_height" maxLength="32" onChange={remainderChange} innerRef={register()} />
                                        <CInputGroupAppend>
...
export default FacebookTagsForm;