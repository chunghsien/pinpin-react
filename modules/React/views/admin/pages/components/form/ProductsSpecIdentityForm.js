...
const ProductsSpecIdentityForm = (props) => {
  ...
  const products_spec_identity = (formRows && formRows.products_spec_identity) ? formRows.products_spec_identity : undefined;
  useEffect(() => {
  ...
  return (
    <>
      <CTabContent>
        <CTabPane data-tab="products-spec-identity-form">
          <CCard className="tab-card">
            ...
            >
              <input
                ...
                name="id"
                ref={register()}
                defaultValue={products_spec_identity && products_spec_identity.id}
              />

              <input
                type="hidden"
                name="products_spec_id"
                ref={register()}
                defaultValue={method_or_id}
              />
              <CRow>
                  ...
                  <CFormGroup>
                    ...
                    <CInputGroup>
                      <CInput
                        ...
                        innerRef={register()}
                        defaultValue={products_spec_identity && products_spec_identity.sku}
                      />
                      <CInputGroupAppend>
                  ...
                  <CFormGroup>
                    ...
                    <CInputGroup>
                      <CInput
                        ...
                        onChange={remainderChange}
                        innerRef={register()}
                        defaultValue={products_spec_identity && products_spec_identity.upc}
                      />
                      <CInputGroupAppend>
                  ...
                  <CFormGroup>
                    ...
                    <CInputGroup>
                      <CInput
                        ...
                        onChange={remainderChange}
                        innerRef={register()}
                        defaultValue={products_spec_identity && products_spec_identity.jan}
                      />
                      <CInputGroupAppend>
                  ...
                  <CFormGroup>
                    ...
                    <CInputGroup>
                      <CInput
                        ...
                        onChange={remainderChange}
                        innerRef={register()}
                        defaultValue={products_spec_identity && products_spec_identity.isbn}
                      />
                      <CInputGroupAppend>
                  ...
                  <CFormGroup>
                    ...
                    <CInputGroup>
                      <CInput
                        ...
                        onChange={remainderChange}
                        innerRef={register()}
                        defaultValue={products_spec_identity && products_spec_identity.mpn}
                      />
                      <CInputGroupAppend>
...
export default connect(mapStateToProps)(ProductsSpecIdentityForm);