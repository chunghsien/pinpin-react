...
const AdminBootstrapTable = (props) => {
    ...
    const ControlsButton = (props) => {
        ...
        const ResetFilterBtn = () => {
            return (
                <button className="btn btn-sm btn-info float-right ml-2" onClick={(e) => resetOnClick(e, tableLastState)}>
    ...
    const deleteApi = (params) => {
        ...
        store.getState().then(function(dispatch) {
            ...
            if (typeof code == 'number' && code === 0) {
                ...
                //錯誤訊息
                //const errorNotify = dispatch.payload.response.data.notify.join("<br />");
