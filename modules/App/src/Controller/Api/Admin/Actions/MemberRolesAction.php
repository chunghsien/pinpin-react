...
use Chopin\Users\TableGateway\MemberRolesTableGateway;

class MemberRolesAction extends AbstractAction
{
    ...
    protected function get(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $response = $ajaxFormService->getProcess($request, new MemberRolesTableGateway($this->adapter));
    ...
    {
        $ajaxFormService = new AjaxFormService();
        return $ajaxFormService->deleteProcess($request, new MemberRolesTableGateway($this->adapter));
    }
    ...
    {
        $ajaxFormService = new AjaxFormService();
        $tablegateway = new MemberRolesTableGateway($this->adapter);
