...
class ManagerRolesAction extends AbstractAction
{
    ...
    protected function get(ServerRequestInterface $request): ResponseInterface
    {
        ...
        $response = $ajaxFormService->getProcess($request, new RolesTableGateway($this->adapter));
    ...
    {
        $ajaxFormService = new AjaxFormService();
        return $ajaxFormService->deleteProcess($request, new RolesTableGateway($this->adapter));
    }
    ...
    {
        $ajaxFormService = new AjaxFormService();
        $tablegateway = new RolesTableGateway($this->adapter);
